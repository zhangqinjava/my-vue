<template>
    <div class="dic" style="width: 100%;height: 1000px;">
       <el-card>
            <Table :data="tableData" :column="tableTitle" :operation="true" :page="false" :loading="loading"style="width: 100%;   height: 1000px;">
               <template #search>
                <div style="display: flex; align-items: center; gap: 10px;">
                        <el-form-item label="分组名称：" style="margin-bottom: 0;">
                            <el-input  v-model="searchForm.groupName" placeholder="请输入分组名称" style="width: 200px;" size="default"/>
                        </el-form-item>
                        <el-form-item label="字典标签：" style="margin-bottom: 0;">
                            <el-input  v-model="searchForm.dicLabel" placeholder="请输入字典标签" style="width: 200px;" size="default"/>
                        </el-form-item>
                        <el-form-item label="字典值：" style="margin-bottom: 0;">
                            <el-input  v-model="searchForm.dicValue" placeholder="请输入字典值" style="width: 200px;" size="default"/>
                        </el-form-item>
                        <el-button @click="onDicList" type="primary" icon="Search">查询</el-button>
                   </div>
                </template>
